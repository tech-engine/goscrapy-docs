---
title: "GoScrapy: high-performance web scraping framework for Go"
description: "Introduction to GoScrapy, a Scrapy-inspired Go framework for building fast, concurrent web scrapers with pipelines, middlewares, and signals."
---
