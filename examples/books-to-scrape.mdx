---
title: "Books to Scrape example: HTML extraction and pagination"
description: "Scrape books.toscrape.com with GoScrapy using CSS selectors, follow pagination links, and export records with the Gosm declarative mapping helper."
---
