---
title: "Scrape Google Finance stock data via RPC API"
description: "Reverse-engineer Google Finance's internal batchexecute RPC endpoint with GoScrapy to fetch structured stock quotes, charts, and historical time series."
---
