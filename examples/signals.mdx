---
title: "Signals example: wire listeners for metrics"
description: "Subscribe to GoScrapy signal bus events to build custom monitoring, log request and response counts, and export live scraping metrics from your spider."
---
