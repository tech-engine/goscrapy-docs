---
title: "GoScrapy architecture and data flow"
description: "How the GoScrapy engine, scheduler, worker pool, middlewares, and pipelines interact through an event-driven flow built for Go concurrency."
---
